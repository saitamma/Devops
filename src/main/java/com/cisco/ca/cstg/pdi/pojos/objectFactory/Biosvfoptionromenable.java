...
@XmlType(name="biosVfOptionROMEnable")
public class Biosvfoptionromenable implements java.io.Serializable {

	private static final long serialVersionUID = 3229571759420604807L;
	...
	public Biosvfoptionromenable() {
	}

	public Biosvfoptionromenable(Biosvprofile biosvprofile) {
		this.biosvprofile = biosvprofile;
	}

	public Biosvfoptionromenable(Biosvprofile biosvprofile, String childAction,
			String rn, String vpState) {
		this.biosvprofile = biosvprofile;
